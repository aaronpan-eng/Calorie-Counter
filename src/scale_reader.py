...
_, thresholded_image = cv2.threshold(
    inverted_image, threshold_value, 255, cv2.THRESH_BINARY
)
...
thresholded_3channel = cv2.GaussianBlur(
    thresholded_3channel, (5, 5), 0
)  # Kernel size (5, 5) can be adjusted
